            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 product">
                        ...
                        <p>ChainGPT offers advanced AI models and tools explicitly designed for Web3, Blockchain, and
                            Crypto use cases.</p>
                    </div>
                    <div class="col-md-6 product">
                        <h2>$CGPT Utility Token</h2>
                        <p>$CGPT is the utility token behind the ChainGPT ecosystem. It is ultimately how individuals
                            and businesses access the AI models, Pad, API, and DAO.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 product">
                        <h2>Staking & Farming</h2>
                        <p>Staking CGPT tokens unlocks multiple benefits, such as APY earnings, tier on ChainGPT Pad,
                            DAO voting power, exclusive airdrops, NFT releases, and additional perks within the ChainGPT
                            ecosystem.</p>
                        <a href="#" class="btn">Enter Staking Dashboard</a>
                    </div>
                    <div class="col-md-6 product">
                        <h2>DAO Voting</h2>
                        <p>ChainGPT Governance enables $CGPT holders to influence the ecosystem through a DAO, where
                            they can propose, vote, and allocate funds.</p>
